...
class BookingState extends Equatable {
  ...
  final RequestState rateBookingState;
  ...
  const BookingState({
    ...
    this.rateBookingState = RequestState.initial,
    this.bookings = const [],
    this.errorMessage,
  });
  ...
  BookingState copyWith({
    ...
    return BookingState(
      ...
      rateBookingState: rateBookingState ?? this.rateBookingState,
